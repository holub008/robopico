import regex  # TODO kholub: any real reason to prefer this to base re? unicode?
import sys
        ...
        try:
            for candidate in best_candidates(sentence):
                try:
                    ...
                    # TODO kholub do we need a logging condition here? is this an "expected" failure mode?
                    print("{} Omitting candidate {}. Reason: {}".format(i, candidate, e.args[0]), file=sys.stderr)
                    omit += 1
                else:
                    try:
            ...
            # TODO kholub do we need a logging condition here? is this an "expected" failure mode?
            print("{} Error processing sentence {}: {}".format(i, sentence, e.args[0]), file=sys.stderr)
